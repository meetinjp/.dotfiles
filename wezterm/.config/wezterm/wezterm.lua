...
-- Hybrid-graphics laptops: when the host swaps GPUs the cached WebGpu adapter
...
-- Launch into WSL Arch Linux. The domain name is "WSL:" + the distribution
-- name reported by `wsl -l -v` (here: archlinux). The default user comes
-- from /etc/wsl.conf inside the distro.
