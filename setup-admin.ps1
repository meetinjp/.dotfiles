...
if (-not $IsAdmin) {
    throw 'setup-admin.ps1 writes to HKLM and must be run from an elevated PowerShell. Open PowerShell as Administrator and rerun.'
}

Write-Host 'Running admin-only machine setup...'
...
Write-Host 'Admin setup complete.'
